...
public class MainActivityTikTacToe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //combinaison des combinaisons gangantes
    ...
    private void performAction(ImageView imageView, int selectedBoxPosition) {
        ...
        if (playerTurn == 1) {
            ...
            if (checkPlayerWin()) {
                ...
                WinDialog winDialog = new WinDialog(MainActivityTikTacToe.this, playerOneName.getText().toString() + " a gagné !", MainActivityTikTacToe.this);
                winDialog.setCancelable(false);
                winDialog.show();
            } else if (totalSelectedBoxes == 9) {
                WinDialog winDialog = new WinDialog(MainActivityTikTacToe.this, "Match nul !", MainActivityTikTacToe.this);
                winDialog.setCancelable(false);
                winDialog.show();
            } else {
                changePlayerTurn(2);
            ...
            if(checkPlayerWin()){
                WinDialog winDialog = new WinDialog(MainActivityTikTacToe.this, playerTwoName.getText().toString() +" a gagné !", MainActivityTikTacToe.this);
                winDialog.setCancelable(false);
                winDialog.show();
            }
            else if (totalSelectedBoxes == 9) {
